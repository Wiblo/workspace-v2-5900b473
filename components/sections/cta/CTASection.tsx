    ...
    <SectionWrapper className={cn("bg-background", className)}>
      <div className="relative mx-auto min-h-[600px] max-h-screen max-w-7xl bg-transparent p-2 xl:max-w-none 2xl:px-48 md:max-h-full">
        <div className="relative flex bg-transparent md:items-center">
          {/* Background Image */}
          <div className="absolute h-full w-full overflow-hidden rounded-3xl bg-muted">
            <Image
          ...
          <div className="flex w-full px-2 pb-2 pt-[200px] md:p-20">
            <div className="flex w-full items-center rounded-3xl bg-background/80 p-8 shadow-xl backdrop-blur-2xl md:min-h-[500px] md:max-w-[600px] md:p-16">
              <div className="flex w-full flex-col gap-6">
                ...
                <div className="flex w-full flex-col gap-8">
                  ...
                  <div className="flex">
                    ...
                    >
                      <span className="pointer-events-none absolute inset-0 rounded-lg bg-black/10 opacity-0 transition-opacity group-hover:opacity-100 hover:rounded-xl" />
